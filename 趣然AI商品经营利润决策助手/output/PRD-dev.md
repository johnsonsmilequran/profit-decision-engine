...
> Issue #5 增量：库存动作改为产品内部必填说明后确认；移除机器人业务通知、User ID、每日催办和人工补发。既有通知数据只读保留，钉钉 OAuth 登录不变。

## 1. 项目一句话

把每周 SPU 经营表转换为固定规则行动清单，并支持主管审核、责任运营在产品内完成经营与库存动作、清仓完成确认及全链路追溯。
...
| US-7 / US-F06-02 | 运营 | 在产品内更新经营与库存状态并提交清仓完成时间 | FR-6 / F06 |
| US-8 / US-F07-01 | 运营 | 仅与主管通过钉钉 OAuth 登录并按角色访问 | FR-7 / F07 |
