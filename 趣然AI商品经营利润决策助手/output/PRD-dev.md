...
| ActionItem | 经营/库存轨、动作类型、责任角色、执行状态、version | 属于稳定 SPU 任务；同动作不重置状态 |
...
完整场景见 `output/requirements.md` 的全部 active AC，包括认证场景 AC-F07-05 至 AC-F07-06、跨周任务场景 AC-F05-06 至 AC-F05-08，以及前序待办与经营状态筛选场景 AC-F05-09 至 AC-F05-10。开发必须至少先走通：
