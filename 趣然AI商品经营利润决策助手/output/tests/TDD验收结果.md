...
- run_completed_at: 2026-08-04T22:31:45+0800
...
| `DESIGN-01` | `passed` | 登录页视觉验收 | 独立审查最终 PASS；`PAGE-F07-01-baseline.png`，1440×900，稳定默认双栏态 |
| `DESIGN-02` | `passed` | 无权限页视觉验收 | 独立审查最终 PASS；`PAGE-F07-02-baseline.png` |
| `DESIGN-03` | `passed` | 工作台视觉验收 | 独立审查最终 PASS；`PAGE-F05-01-baseline.png` |
| `DESIGN-04` | `passed` | 批次列表视觉验收 | 独立审查最终 PASS；`PAGE-F01-01-baseline.png`，长批次 ID 无列间重叠 |
| `DESIGN-05` | `passed` | 新建导入视觉验收 | 独立审查最终 PASS；`PAGE-F01-02-baseline.png` 与 `PAGE-F01-02-confirm.png` |
| `DESIGN-06` | `passed` | 批次详情视觉验收 | 独立审查最终 PASS；`PAGE-F01-03-baseline.png` |
| `DESIGN-07` | `passed` | 行动清单视觉验收 | 独立审查最终 PASS；`PAGE-F05-02-baseline.png` |
| `DESIGN-08` | `passed` | 建议详情视觉验收 | 独立审查最终 PASS；`PAGE-F05-03-baseline.png` 与 `PAGE-F05-03-confirm.png` |
| `DESIGN-09` | `passed` | 追溯记录视觉验收 | 独立审查最终 PASS；`PAGE-F08-01-baseline.png` |
