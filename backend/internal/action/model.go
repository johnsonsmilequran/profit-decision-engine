...
type Item struct {
	...
	LatestAIStatus              string                 `json:"latest_ai_status"`
	LatestNotificationStatus    *string                `json:"latest_notification_status"`
	LatestNotificationErrorCode *string                `json:"latest_notification_error_code"`
	LatestClearanceStatus       *string                `json:"latest_clearance_status"`
