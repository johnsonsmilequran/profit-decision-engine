...
| 对象 | 统一示例值 |
| :--- | :--- |
| 当前批次 | `BATCH-20260805-C4F8A2D8`；玩具事业部；数据期间 `2026-07-01—2026-07-31`；业务截止日 `2026-08-05`；有效 SPU `10`、决策 `7`、清仓 `6` |
...
| 主展示 SPU 闭环状态 | 主管已通过；责任运营缘一的经营轨与库存轨均待执行；清仓完成时间待提交；当日钉钉催办已被官方接受且收件人当时未读，业务状态不自动推进 |
